...
public partial class meuEspaco : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            else
            {
                ...
                string cpf = cpfClienteAlt.Text;

                Conexao conn = new Conexao();

                string sqlStringVerificar = "select nome, cpf, email, telefone  from Cliente c inner join Login_ l on l.id_login=c.id_login where l.usuario=@usuario and l.senha=@senha";
                ...
                while (conn.dr.Read())
                {
                    ...
                    cpfClienteAlt.Text = conn.dr[1].ToString();
    ...
    public void btnAlteraDados_Click(object sender, EventArgs e)
    {
        ...
        {
            retornoAlt = cafeteria.alterarDados.alterarDCadastrais(nome, email, telefone, usuarioAltDados);
